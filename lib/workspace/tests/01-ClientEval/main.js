...
describe("Suite", function() {
    ...
    require(process.env.DOMPLATE_REP_WORKSPACE__BASH_ORIGIN_WORKSPACE_PATH).LIB.BASH_ORIGIN_EXPRESS.runForTestHooks(before, after, {
        "routes": {
            "^/reps/": {
    ...
    it('Test', function (client) {
        ...
        client.execute(function(selector) {
            ...
            var expected = CODEBLOCK.thawFromJSON(repCode.tests["01"].result).getCode().trim();
